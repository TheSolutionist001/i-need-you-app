...
- **Nächste Schritte:** Phase 5 (Sicherheit: Melde-Button-UI, Shadow-Ban-Anzeige, Admin-Dashboard mit Rollenkonzept). Die Shadow-Ban-Regel + `reports`-Tabelle stehen schon. Push beim Nachrücken kommt in Phase 6.
